...
abstract final class ReceiptStrings {
  ...
  static const undeclaredValueCompensationMultiplier = '၅';
  static const voucherTerms = [
    ...
    'တန်ဖိုးမဖော်ပြသော ကုန်ပစ္စည်းများ ပျောက်ဆုံးပါက တန်ဆာ၏ ($undeclaredValueCompensationMultiplier) ဆကိုသာ ပေးလျော်ပါမည်။',
